...
MAILCHIMP_SECRET_API_KEY = os.getenv('MAILCHIMP_SECRET_API_KEY')
MAILCHIMP_LIST_NEWSLETTER_ID = os.getenv('MAILCHIMP_LIST_NEWSLETTER_ID')
MAILCHIMP_LATEST_NEWS_ID = os.getenv('MAILCHIMP_LATEST_NEWS_ID')
MAILCHIMP_NEW_PRODUCT_ID = os.getenv('MAILCHIMP_NEW_PRODUCT_ID')
MAILCHIMP_OFFER_ID = os.getenv('MAILCHIMP_OFFER_ID')