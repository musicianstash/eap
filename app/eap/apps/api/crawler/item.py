...
def save_spider_item(item_data):
    ...
    brand = get_item_brand_id_from_brand_name(item_data['brand'])
    color = get_item_color_id_from_color_name(item_data['color'])
...
def get_item_brand_id_from_brand_name(brand):
    return Brand.objects.get(name__istartswith=brand)


def get_item_color_id_from_color_name(color):
